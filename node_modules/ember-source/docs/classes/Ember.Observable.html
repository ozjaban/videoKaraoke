...
<head>
    <meta charset="utf-8">
    <title>Ember.Observable - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Observable Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-runtime_lib_mixins_observable.js.html#l26"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;observable.js:26</code></a>
        </div>
...
<h2>Using <code>get()</code> and <code>set()</code></h2>
...
<h2>Observing Property Changes</h2>
<p>You typically observe property changes simply by using the <code>Ember.observer</code>
...
<pre class="code prettyprint"><code class="language-javascript">object.addObserver('propertyKey', targetObject, targetAction)
</code></pre>
...
<div id="method_decrementProperty" class="method item public">
...
<div id="method_hasObserverFor" class="method item private">
...
<div id="method_incrementProperty" class="method item public">
...
<div id="method_notifyPropertyChange" class="method item public">
...
<div id="method_toggleProperty" class="method item public">

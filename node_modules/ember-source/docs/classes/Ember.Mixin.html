...
<head>
    <meta charset="utf-8">
    <title>Ember.Mixin - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Mixin Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_mixin.js.html#l416"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;mixin.js:416</code></a>
        </div>
...
<div class="box intro">
    <p>The <code>Ember.Mixin</code> class allows you to create mixins, whose properties can be
added to other classes. For instance,</p>
<pre class="code prettyprint"><code class="language-javascript">const EditableMixin = Ember.Mixin.create({
  edit() {
...
<pre class="code prettyprint"><code class="language-javascript">// filters array will be shared amongst any object implementing mixin
...
<div id="method_apply" class="method item private">
...
<div id="method_create" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_mixin.js.html#l520"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;mixin.js:520</code></a>
        </p>
...
<div id="method_reopen" class="method item private">

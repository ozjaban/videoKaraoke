...
<head>
    <meta charset="utf-8">
    <title>Ember.ActionSupport - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.ActionSupport Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-views_lib_mixins_action_support.js.html#l22"><code>packages&#x2F;ember-views&#x2F;lib&#x2F;mixins&#x2F;action_support.js:22</code></a>
        </div>
...
<div id="method_sendAction" class="method item public">
    ...
    <div class="description">
        <p>Calls an action passed to a component.</p>
<p>For example a component for playing or pausing music may translate click events
into action notifications of &quot;play&quot; or &quot;stop&quot; depending on some internal state
of the component:</p>
<pre class="code prettyprint"><code class="language-javascript">// app/components/play-button.js
...
<pre class="code prettyprint"><code class="language-javascript">// app/controller/application.js
...
is assumed.</p>
<pre class="code prettyprint"><code class="language-javascript">// app/components/next-button.js
export default Ember.Component.extend({
  click() {
    this.sendAction();
  }

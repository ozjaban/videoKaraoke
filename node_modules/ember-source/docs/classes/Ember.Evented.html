...
<head>
    <meta charset="utf-8">
    <title>Ember.Evented - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Evented Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-runtime_lib_mixins_evented.js.html#l14"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;evented.js:14</code></a>
        </div>
...
<div class="box intro">
    <p>This mixin allows for Ember objects to subscribe to and emit events.</p>
<pre class="code prettyprint"><code class="language-javascript">App.Person = Ember.Object.extend(Ember.Evented, {
  greet: function() {
    // ...
    this.trigger('greet');
  }
...
<pre class="code prettyprint"><code class="language-javascript">person.on('greet', function() {
  console.log('Our person has greeted');
}).one('greet', function() {
...
<div id="method_has" class="method item public">
...
<div id="method_off" class="method item public">
...
<div id="method_one" class="method item public">
...
<div id="method_trigger" class="method item public">
...
event.</p>
<pre class="code prettyprint"><code class="language-javascript">person.on('didEat', function(food) {

...
<head>
    <meta charset="utf-8">
    <title>Ember.Helper - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Helper Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-glimmer_lib_helper.js.html#l12"><code>packages&#x2F;ember-glimmer&#x2F;lib&#x2F;helper.js:12</code></a>
        </div>
...
<div class="box intro">
    <p>Ember Helpers are functions that can compute values, and are used in templates.
For example, this code calls a helper named <code>format-currency</code>:</p>
<pre class="code prettyprint"><code class="language-handlebars">&lt;div&gt;{{format-currency cents currency=&quot;$&quot;}}&lt;/div&gt;
</code></pre>
...
<pre class="code prettyprint"><code class="language-handlebars">{{show-money amount=(format-currency cents currency=&quot;$&quot;)}}
</code></pre>
<p>Helpers defined using a class must provide a <code>compute</code> function. For example:</p>
<pre class="code prettyprint"><code class="language-js">export default Ember.Helper.extend({
  compute(params, hash) {
    let cents = params[0];
    let currency = hash.currency;
    return <code>${currency}${cents * 0.01}</code>;
  }
});
</code></pre>
            ...
            <h2 class="off-left">Item Index</h2>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            ...
                            <li class="index-item method public">
                                <a href="#method_helper">helper</a>

                                    <span class="flag static">static</span>
                            </li>
                            <li class="index-item method public">
                                <a href="#method_recompute">recompute</a>
...
<div id="method_compute" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-glimmer_lib_helper.js.html#l88"><code>packages&#x2F;ember-glimmer&#x2F;lib&#x2F;helper.js:88</code></a>
        </p>
    ...
    <div class="description">
        <p>Override this function when writing a class-based helper.</p>
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>The positional arguments to the helper</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>The named arguments to the helper</p>
...
<div id="method_helper" class="method item public">
    <h3 class="name"><code>helper</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-glimmer_lib_helper.js.html#l103"><code>packages&#x2F;ember-glimmer&#x2F;lib&#x2F;helper.js:103</code></a>
        </p>
    ...
    <div class="description">
        <p>In many cases, the ceremony of a full <code>Ember.Helper</code> class is not required.
The <code>helper</code> method create pure-function helpers without instances. For
example:</p>
<pre class="code prettyprint"><code class="language-js">// app/helpers/format-currency.js
...
<div id="method_recompute" class="method item public">
    <h3 class="name"><code>recompute</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-glimmer_lib_helper.js.html#l60"><code>packages&#x2F;ember-glimmer&#x2F;lib&#x2F;helper.js:60</code></a>
        </p>
    ...
    <div class="description">
        <p>On a class-based helper, it may be useful to force a recomputation of that
...
<pre class="code prettyprint"><code class="language-js">// app/helpers/current-user-email.js

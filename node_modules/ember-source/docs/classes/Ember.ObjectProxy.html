...
<head>
    <meta charset="utf-8">
    <title>Ember.ObjectProxy - The Ember API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/packages_ember-runtime_lib_system_object_proxy.js.html#l4"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;system&#x2F;object_proxy.js:4</code></a>
        </div>
...
<div class="box intro">
    <p><code>Ember.ObjectProxy</code> forwards all properties not defined by the proxy itself
to a proxied <code>content</code> object.</p>
<pre class="code prettyprint"><code class="language-javascript">object = Ember.Object.create({
  name: 'Foo'
});
...
// Create new 'description' property on <code>object</code>
proxy.set('description', 'Foo is a whizboo baz');
object.get('description')  // 'Foo is a whizboo baz'
</code></pre>
<p>While <code>content</code> is unset, setting a property to be delegated will throw an
Error.</p>
<pre class="code prettyprint"><code class="language-javascript">proxy = Ember.ObjectProxy.create({
  content: null,
  flag: null
});
proxy.set('flag', true);
...
<pre class="code prettyprint"><code class="language-javascript">ProxyWithComputedProperty = Ember.ObjectProxy.extend({

...
<head>
    <meta charset="utf-8">
    <title>Ember.Location - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Location Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-routing_lib_location_api.js.html#l10"><code>packages&#x2F;ember-routing&#x2F;lib&#x2F;location&#x2F;api.js:10</code></a>
        </div>
...
<div class="box intro">
    <p>Ember.Location returns an instance of the correct implementation of
...
<div id="method_create" class="method item private deprecated">
    <h3 class="name"><code>create</code></h3>
        ...
        <span class="flag deprecated" title="Use the container to lookup the location implementation that you
 need.">deprecated</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-routing_lib_location_api.js.html#l147"><code>packages&#x2F;ember-routing&#x2F;lib&#x2F;location&#x2F;api.js:147</code></a>
        </p>


            <p>Deprecated: Use the container to lookup the location implementation that you
 need.</p>

    </div>

    <div class="description">
        <p>This is deprecated in favor of using the container to lookup the location
implementation as desired.</p>
<p>For example:</p>
<pre class="code prettyprint"><code class="language-javascript">// Given a location registered as follows:
...
container.lookup('location:history-test');
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Object</span>:
                    <p>an instance of an implementation of the <code>location</code> API</p>
...
<div id="method_getHash" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-routing_lib_location_api.js.html#l181"><code>packages&#x2F;ember-routing&#x2F;lib&#x2F;location&#x2F;api.js:181</code></a>
        </p>
    ...
    <div class="description">
        <p>Returns the current <code>location.hash</code> by parsing location.href since browsers

...
<head>
    <meta charset="utf-8">
    <title>Ember.PromiseProxyMixin - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.PromiseProxyMixin Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l40"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:40</code></a>
        </div>
...
<div class="box intro">
    <p>A low level mixin making ObjectProxy promise-aware.</p>
<pre class="code prettyprint"><code class="language-javascript">let ObjectPromiseProxy = Ember.ObjectProxy.extend(Ember.PromiseProxyMixin);
...
<pre class="code prettyprint"><code class="language-javascript">proxy.get('isPending')   //=&gt; true
...
<pre class="code prettyprint"><code class="language-javascript">proxy.get('isPending')   //=&gt; false
...
<pre class="code prettyprint"><code class="language-javascript">// Assuming the following json:
{
  firstName: 'Stefan',
  lastName: 'Penner'
}
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property public">
                                <a href="#property_isFulfilled">isFulfilled</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_isPending">isPending</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_isRejected">isRejected</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_isSettled">isSettled</a>
                            ...
                            <li class="index-item property public">
                                <a href="#property_reason">reason</a>
...
<div id="method_catch" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l183"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:183</code></a>
        </p>
    ...
    <div class="description">
        <p>An alias to the proxied promise's <code>catch</code>.</p>
...
<div id="method_finally" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l196"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:196</code></a>
        </p>
    ...
    <div class="description">
        <p>An alias to the proxied promise's <code>finally</code>.</p>
...
<div id="method_then" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l171"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:171</code></a>
        </p>
    ...
    <div class="description">
        <p>An alias to the proxied promise's <code>then</code>.</p>
...
<div id="property_isFulfilled" class="property item public">
    <h3 class="name"><code>isFulfilled</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l136"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:136</code></a>
        </p>
    ...
    <div class="description">
        <p>Will become <code>true</code> if the proxied promise is fulfilled.</p>
...
<div id="property_isPending" class="property item public">
    <h3 class="name"><code>isPending</code></h3>
    <span class="type">Unknown</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l109"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:109</code></a>
        </p>
    ...
    <div class="description">
        <p>Once the proxied promise has settled this will become <code>false</code>.</p>
...
<div id="property_isRejected" class="property item public">
    <h3 class="name"><code>isRejected</code></h3>
    <span class="type">Unknown</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l127"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:127</code></a>
        </p>
    ...
    <div class="description">
        <p>Will become <code>true</code> if the proxied promise is rejected.</p>
...
<div id="property_isSettled" class="property item public">
    <h3 class="name"><code>isSettled</code></h3>
    <span class="type">Unknown</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l118"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:118</code></a>
        </p>
    ...
    <div class="description">
        <p>Once the proxied promise has settled this will become <code>true</code>.</p>
...
<div id="property_promise" class="property item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l145"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:145</code></a>
        </p>
    ...
    <div class="description">
        <p>The promise whose fulfillment value is being proxied by this object.</p>
<p>This property must be specified upon creation, and should not be
changed once created.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">Ember.ObjectProxy.extend(Ember.PromiseProxyMixin).create({
  promise: &lt;thenable&gt;
});
</code></pre>
...
<div id="property_reason" class="property item public">
    <h3 class="name"><code>reason</code></h3>
    <span class="type">Unknown</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_mixins_promise_proxy.js.html#l99"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;mixins&#x2F;promise_proxy.js:99</code></a>
        </p>
    ...
    <div class="description">
        <p>If the proxied promise is rejected this will contain the reason
provided.</p>

...
<head>
    <meta charset="utf-8">
    <title>RoutingService - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>RoutingService Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-routing_lib_services_routing.js.html#l15"><code>packages&#x2F;ember-routing&#x2F;lib&#x2F;services&#x2F;routing.js:15</code></a>
        </div>
...
<div class="box intro">
    <p>The Routing service is used by LinkComponent, and provides facilities for
the component/view layer to interact with the router.</p>
<p>While still private, this service can eventually be opened up, and provides
the set of API needed for components to control routing without interacting
with router internals.</p>

...
<head>
    <meta charset="utf-8">
    <title>Ember.HTMLBars - The Ember API</title>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method private">
                                <a href="#method_makeBoundHelper">makeBoundHelper</a>
...
<div id="method_makeBoundHelper" class="method item private">
    <h3 class="name"><code>makeBoundHelper</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-glimmer_lib_make-bound-helper.js.html#l8"><code>packages&#x2F;ember-glimmer&#x2F;lib&#x2F;make-bound-helper.js:8</code></a>
        </p>
    ...
    <div class="description">
        <p>Create a bound helper. Accepts a function that receives the ordered and hash parameters
...
<ul>
<li>
<p>With an unquoted ordered parameter:</p>
<pre class="code prettyprint"><code class="language-javascript">{{x-capitalize foo}}
</code></pre>
...
<li>
<p>With a quoted ordered parameter:</p>
<pre class="code prettyprint"><code class="language-javascript">{{x-capitalize &quot;foo&quot;}}
</code></pre>
<p>The bound helper would receive <code>[&quot;foo&quot;]</code> as its first argument, and an empty hash as its second.</p>
</li>
<li>
<p>With an unquoted hash parameter:</p>
<pre class="code prettyprint"><code class="language-javascript">{{x-repeat &quot;foo&quot; count=repeatCount}}
</code></pre>

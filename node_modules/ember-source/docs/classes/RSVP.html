...
<head>
    <meta charset="utf-8">
    <title>RSVP - The Ember API</title>
            ...
            <h2 class="off-left">Item Index</h2>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            ...
                            <li class="index-item method">
                                <a href="#method_allSettled">allSettled</a>

                                    <span class="flag static">static</span>
                            </li>
                            <li class="index-item method">
                                <a href="#method_defer">defer</a>

                                    <span class="flag static">static</span>
                            </li>
                            <li class="index-item method">
                                <a href="#method_denodeify">denodeify</a>
                            ...
                            <li class="index-item method">
                                <a href="#method_hashSettled">hashSettled</a>
                            ...
                            <li class="index-item method">
                                <a href="#method_rethrow">rethrow</a>
...
<div id="method_all" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_promise_all.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;promise&#x2F;all.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.Promise.all</code> accepts an array of promises, and returns a new promise which
is fulfilled with an array of fulfillment values for the passed promises, or
rejected with the reason of the first passed promise to be rejected. It casts all
elements of the passed iterable to promises as it runs this algorithm.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">let promise1 = RSVP.resolve(1);
  ...
  // error.message === &quot;2&quot;
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">entries</code>
                        <span class="type">Array</span>


                    <div class="param-description">
                        <p>array of promises</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>optional string for labeling the promise.
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>promise that is fulfilled when all <code>promises</code> have been
fulfilled, or rejected if any of them become rejected.</p>
...
<div id="method_all" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_all.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;all.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p>This is a convenient alias for <code>RSVP.Promise.all</code>.</p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>An optional label. This is useful
for tooling.</p>
...
<div id="method_allSettled" class="method item">
    <h3 class="name"><code>allSettled</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_all-settled.js.html#l19"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;all-settled.js:19</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.allSettled</code> is similar to <code>RSVP.all</code>, but instead of implementing
...
<pre class="code prettyprint"><code class="language-javascript">{ state: 'fulfilled', value: value }
  or
{ state: 'rejected', reason: reason }
</code></pre>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">let promise1 = RSVP.Promise.resolve(1);
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <ul>
<li>optional string that describes the promise.
Useful for tooling.</li>
</ul>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>promise that is fulfilled with an array of the settled
states of the constituent promises.</p>
...
<div id="method_defer" class="method item">
    <h3 class="name"><code>defer</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_defer.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;defer.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.defer</code> returns an object similar to jQuery's <code>$.Deferred</code>.
...
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">let deferred = RSVP.defer();
...
<div id="method_denodeify" class="method item">
    <h3 class="name"><code>denodeify</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_node.js.html#l71"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;node.js:71</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.denodeify</code> takes a 'node-style' function and returns a function that
...
<pre class="code prettyprint"><code class="language-javascript">let fs = require('fs');
...
<pre class="code prettyprint"><code class="language-javascript">let request = RSVP.denodeify(require('request'));
...
as an array:</p>
<pre class="code prettyprint"><code class="language-javascript">let request = RSVP.denodeify(require('request'), true);
...
<pre class="code prettyprint"><code class="language-javascript">let request = RSVP.denodeify(require('request'), ['res', 'body']);
...
<pre class="code prettyprint"><code class="language-javascript">let app = require('express')();
...
readFile('myfile.txt').then(function(data){
  ...
  // Handle error
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">nodeFunc</code>
                        <span class="type"><a href="../classes/Function.html" class="crosslink">Function</a></span>


                    <div class="param-description">
                        <p>a 'node-style' function that takes a callback as
its last argument. The callback expects an error to be passed as its first
argument (if an error occurred, otherwise null), and the value from the
operation as its second argument ('function(err, value){ }').</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>An optional paramter that if set
to <code>true</code> causes the promise to fulfill with the callback's success arguments
...
values.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/Function.html" class="crosslink">Function</a></span>:
                    <p>a function that wraps <code>nodeFunc</code> to return an
<code>RSVP.Promise</code></p>
...
<div id="method_filter" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_filter.js.html#l7"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;filter.js:7</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.filter</code> is similar to JavaScript's native <code>filter</code> method, except that it
...
RSVP.filter(promises, filterFn).then(function(users){
  ...
  users.length === 1;
  // false, because Alice is the only user present in <code>users</code>
  users[0] === bob;
});
</code></pre>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">promises</code>
                        <span class="type">Array</span>
                ...
                <li class="param">
                        <code class="param-name">filterFn</code>
                        <span class="type"><a href="../classes/Function.html" class="crosslink">Function</a></span>


                    <div class="param-description">
                        <ul>
<li>function to be called on each resolved value to
filter the final results.</li>
</ul>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>optional string describing the promise. Useful for
tooling.</p>
...
<div id="method_hash" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_hash.js.html#l4"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;hash.js:4</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.hash</code> is similar to <code>RSVP.all</code>, but takes an object instead of an array
...
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">let promises = {
...
chains.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">function MyConstructor(){
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>optional string that describes the promise.
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>promise that is fulfilled when all properties of <code>promises</code>
have been fulfilled, or rejected if any of them become rejected.</p>
...
<div id="method_hashSettled" class="method item">
    <h3 class="name"><code>hashSettled</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_hash-settled.js.html#l23"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;hash-settled.js:23</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.hashSettled</code> is similar to <code>RSVP.allSettled</code>, but takes an object
...
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>promise that is fulfilled when when all properties of <code>promises</code>
have been settled.</p>
...
<div id="method_map" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_map.js.html#l6"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;map.js:6</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.map</code> is similar to JavaScript's native <code>map</code> method, except that it
...
<pre class="code prettyprint"><code class="language-javscript">
  ...
  // of all blog posts returned from getBlogPosts()
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                        <code class="param-name">mapFn</code>
                        <span class="type"><a href="../classes/Function.html" class="crosslink">Function</a></span>


                    <div class="param-description">
                        <p>function to be called on each fulfilled promise.</p>
...
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>promise that is fulfilled with the result of calling
<code>mapFn</code> on each fulfilled promise or value when they become fulfilled.
The promise will be rejected if any of the given <code>promises</code> become rejected.</p>
...
<div id="method_race" class="method item">
    <h3 class="name"><code>race</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_promise_race.js.html#l13"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;promise&#x2F;race.js:13</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.Promise.race</code> returns a new promise which is settled in the same way as the
first passed promise to settle.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">let promise1 = new RSVP.Promise(function(resolve, reject){
  setTimeout(function(){
    resolve('promise 1');
  }, 200);
});
...
<p><code>RSVP.Promise.race</code> is deterministic in that only the state of the first
...
<pre class="code prettyprint"><code class="language-javascript">RSVP.Promise.race([ajax('foo.json'), timeout(5000)])
</code></pre>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>array of promises to observe</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>optional string for describing the promise returned.
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise which settles in the same way as the first passed
promise to settle.</p>
...
<div id="method_race" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_race.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;race.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p>This is a convenient alias for <code>RSVP.Promise.race</code>.</p>
...
<div id="method_reject" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_promise_reject.js.html#l6"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;promise&#x2F;reject.js:6</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.Promise.reject</code> returns a promise rejected with the passed <code>reason</code>.
It is shorthand for the following:</p>
<pre class="code prettyprint"><code class="language-javascript">let promise = new RSVP.Promise(function(resolve, reject){
...
<pre class="code prettyprint"><code class="language-javascript">let promise = RSVP.Promise.reject(new Error('WHOOPS'));
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>value that the returned promise will be rejected with.</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>optional string for identifying the returned promise.
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise rejected with the given <code>reason</code>.</p>
...
<div id="method_reject" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_reject.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;reject.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p>This is a convenient alias for <code>RSVP.Promise.reject</code>.</p>
...
<div id="method_resolve" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_promise_resolve.js.html#l6"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;promise&#x2F;resolve.js:6</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.Promise.resolve</code> returns a promise that will become resolved with the
...
<p>Instead of writing the above, your code now simply becomes the following:</p>
<pre class="code prettyprint"><code class="language-javascript">let promise = RSVP.Promise.resolve(1);
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>value that the returned promise will be resolved with</p>
...
Useful for tooling.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise that will become fulfilled with the given
<code>value</code></p>
...
<div id="method_resolve" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_resolve.js.html#l3"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;resolve.js:3</code></a>
        </p>
    ...
    <div class="description">
        <p>This is a convenient alias for <code>RSVP.Promise.resolve</code>.</p>
...
<div id="method_rethrow" class="method item">
    <h3 class="name"><code>rethrow</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/node_modules_rsvp_lib_rsvp_rethrow.js.html#l1"><code>node_modules&#x2F;rsvp&#x2F;lib&#x2F;rsvp&#x2F;rethrow.js:1</code></a>
        </p>
    ...
    <div class="description">
        <p><code>RSVP.rethrow</code> will rethrow an error on the next turn of the JavaScript event
...
<pre class="code prettyprint"><code class="language-javascript">function throws(){
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>reason the promise became rejected.</p>

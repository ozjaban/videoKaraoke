...
<head>
    <meta charset="utf-8">
    <title>Descriptor - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Descriptor Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_properties.js.html#l13"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;properties.js:13</code></a>
        </div>
...
<div class="box intro">
    <p>Objects of this type can implement an interface to respond to requests to
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method private">
                                <a href="#method_deprecateProperty">deprecateProperty</a>
...
<div id="method_deprecateProperty" class="method item private">
    <h3 class="name"><code>deprecateProperty</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_deprecate_property.js.html#l11"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;deprecate_property.js:11</code></a>
        </p>
    ...
    <div class="description">
        <p>Used internally to allow changing properties in a backwards compatible way, and print a helpful
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>The object to add the deprecated property to.</p>

                    </div>

                </li>
                <li class="param">
                        <code class="param-name">deprecatedKey</code>
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>


                    <div class="param-description">
                        <p>The property to add (and print deprecation warnings upon accessing).</p>

                    </div>

                </li>
                <li class="param">
                        <code class="param-name">newKey</code>
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>


                    <div class="param-description">
                        <p>The property that will be aliased.</p>

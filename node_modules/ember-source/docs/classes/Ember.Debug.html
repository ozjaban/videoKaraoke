...
<head>
    <meta charset="utf-8">
    <title>Ember.Debug - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Debug Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-debug_lib_index.js.html#l223"><code>packages&#x2F;ember-debug&#x2F;lib&#x2F;index.js:223</code></a>
        </div>

            Module: <a href="../modules/ember-debug.html">ember-debug</a><br>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method public">
                                <a href="#method_registerDeprecationHandler">registerDeprecationHandler</a>

                                    <span class="flag static">static</span>
                            </li>
                            <li class="index-item method public">
                                <a href="#method_registerWarnHandler">registerWarnHandler</a>
...
<div id="method_registerDeprecationHandler" class="method item public">
    <h3 class="name"><code>registerDeprecationHandler</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-debug_lib_index.js.html#l229"><code>packages&#x2F;ember-debug&#x2F;lib&#x2F;index.js:229</code></a>
        </p>
    ...
    <div class="description">
        <p>Allows for runtime registration of handler functions that override the default deprecation behavior.
...
<pre class="code prettyprint"><code class="language-javascript">Ember.Debug.registerDeprecationHandler((message, options, next) =&gt; {
  if (message.indexOf('should') !== -1) {
    throw new Error(<code>Deprecation message with should: ${message}</code>);
  } else {
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>A function to handle deprecation calls.</p>
...
<div id="method_registerWarnHandler" class="method item public">
    <h3 class="name"><code>registerWarnHandler</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-debug_lib_index.js.html#l265"><code>packages&#x2F;ember-debug&#x2F;lib&#x2F;index.js:265</code></a>
        </p>
    ...
    <div class="description">
        <p>Allows for runtime registration of handler functions that override the default warning behavior.
...
<pre class="code prettyprint"><code class="language-javascript">// next is not called, so no warnings get the default behavior
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>A function to handle warnings.</p>

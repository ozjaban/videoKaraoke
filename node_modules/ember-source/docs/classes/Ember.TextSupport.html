...
<head>
    <meta charset="utf-8">
    <title>Ember.TextSupport - The Ember API</title>
...
<div class="box meta">
        ...
        <div class="extends">
            Extends <a href="../classes/Ember.Mixin.html" class="crosslink">Ember.Mixin</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/packages_ember-views_lib_mixins_text_support.js.html#l18"><code>packages&#x2F;ember-views&#x2F;lib&#x2F;mixins&#x2F;text_support.js:18</code></a>
        </div>
...
<div class="box intro">
    <p><code>TextSupport</code> is a shared mixin used by both <code>Ember.TextField</code> and
...
<pre class="code prettyprint"><code>The Template
+---------------------------+
|                           |
...
<pre class="code prettyprint"><code class="language-handlebars">  {{input attribute-name='controllerAction'}}
</code></pre>
...
<div id="method_apply" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Mixin.html#method_apply">Ember.Mixin</a>:
        <a href="../files/packages_ember-metal_lib_mixin.js.html#l572"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;mixin.js:572</code></a>
        </p>
...
<div id="method_cancel" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when the escape button
...
<div id="method_detect" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Mixin.html#method_detect">Ember.Mixin</a>:
        <a href="../files/packages_ember-metal_lib_mixin.js.html#l603"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;mixin.js:603</code></a>
        </p>
...
<div id="method_focusIn" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when a field receives
...
<div id="method_focusOut" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when a field loses
...
<div id="method_insertNewline" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when either the <code>enter</code>
...
<div id="method_keyDown" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when a key-down event is
...
<div id="method_keyPress" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when a key is pressed.
...
<div id="method_keyUp" class="method item private">
    ...
    <div class="description">
        <p>Allows you to specify a controller action to invoke when a key-up event is
...
<div id="method_reopen" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Mixin.html#method_reopen">Ember.Mixin</a>:
        <a href="../files/packages_ember-metal_lib_mixin.js.html#l535"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;mixin.js:535</code></a>
        </p>
...
<div id="method_triggerAction" class="method item private inherited">
    ...
    <div class="description">
        <p>Send an <code>action</code> with an <code>actionContext</code> to a <code>target</code>. The action, actionContext
and target will be retrieved from properties of the object. For example:</p>
<pre class="code prettyprint"><code class="language-javascript">App.SaveButtonView = Ember.View.extend(Ember.TargetActionSupport, {
    ...
    this.triggerAction({
      action: 'save'
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>(optional, with the optional keys action, target and/or actionContext)</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Boolean</span>:
                    <p>true if the action was sent successfully and did not return false</p>
...
<div id="property_action" class="property item private">
    ...
    <div class="description">
        <p>The action to be sent when the user presses the return key.</p>
...
<div id="property_bubbles" class="property item private">
    ...
    <div class="description">
        <p>Whether the <code>keyUp</code> event that triggers an <code>action</code> to be sent continues
...
<div id="property_onEvent" class="property item private">
    ...
    <div class="description">
        <p>The event that should send the action.</p>
<p>Options are:</p>
<ul>

...
<head>
    <meta charset="utf-8">
    <title>Ember.Instrumentation - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Instrumentation Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_instrumentation.js.html#l4"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;instrumentation.js:4</code></a>
        </div>
...
<div class="box intro">
    <p>The purpose of the Ember Instrumentation module is
to provide efficient, general-purpose instrumentation
for Ember.</p>
<p>Subscribe to a listener by using <code>Ember.subscribe</code>:</p>
<pre class="code prettyprint"><code class="language-javascript">Ember.subscribe(&quot;render&quot;, {
...
<pre class="code prettyprint"><code class="language-javascript">Ember.instrument(&quot;render.handlebars&quot;, payload, function() {
  // rendering logic
}, binding);
</code></pre>
...
<div id="method_instrument" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_instrumentation.js.html#l78"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;instrumentation.js:78</code></a>
        </p>
    ...
    <div class="description">
        <p>Notifies event's subscribers, calls <code>before</code> and <code>after</code> hooks.</p>
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>Namespaced event name.</p>

                    </div>

                </li>
                <li class="param">
                        <code class="param-name">_payload</code>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>Function that you're instrumenting.</p>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>Context that instrument function is called with.</p>
...
<div id="method_reset" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_instrumentation.js.html#l244"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;instrumentation.js:244</code></a>
        </p>
    ...
    <div class="description">
        <p>Resets <code>Ember.Instrumentation</code> by flushing list of subscribers.</p>
...
<div id="method_subscribe" class="method item private">
    <h3 class="name"><code>subscribe</code></h3>
        ...
        <div class="args">
            <span class="paren">(</span><ul class="args-list inline commas">
                <li class="arg">
                        <code class="optional">[pattern]</code>
                </li>
                <li class="arg">
        ...
        <span class="returns-inline">
            <span class="type">Subscriber</span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_instrumentation.js.html#l181"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;instrumentation.js:181</code></a>
        </p>
    ...
    <div class="description">
        <p>Subscribes to a particular event or instrumented block of code.</p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name optional">[pattern]</code>
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>
                        <span class="flag optional" title="This parameter is optional.">optional</span>
...
<div id="method_unsubscribe" class="method item private">
    <h3 class="name"><code>unsubscribe</code></h3>

        <div class="args">
            <span class="paren">(</span><ul class="args-list inline commas">
                <li class="arg">
                        <code class="optional">[subscriber]</code>
                </li>
            </ul><span class="paren">)</span>
        </div>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_instrumentation.js.html#l222"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;instrumentation.js:222</code></a>
        </p>
    ...
    <div class="description">
        <p>Unsubscribes from a particular event or instrumented block of code.</p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name optional">[subscriber]</code>
                        <span class="type">Object</span>
                        <span class="flag optional" title="This parameter is optional.">optional</span>

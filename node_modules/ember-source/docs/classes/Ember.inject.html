...
<head>
    <meta charset="utf-8">
    <title>Ember.inject - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.inject Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-runtime_lib_inject.js.html#l6"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;inject.js:6</code></a>
        </div>
...
<div class="box intro">
    <p>Namespace for injection helper methods.</p>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method public">
                                <a href="#method_controller">controller</a>

                            </li>
                            <li class="index-item method public">
                                <a href="#method_service">service</a>
...
<div id="method_controller" class="method item public">
    <h3 class="name"><code>controller</code></h3>
        ...
        <span class="returns-inline">
            <span class="type"><a href="../classes/Ember.InjectedProperty.html" class="crosslink">Ember.InjectedProperty</a></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_controllers_controller.js.html#l31"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;controllers&#x2F;controller.js:31</code></a>
        </p>
    ...
    <div class="description">
        <p>Creates a property that lazily looks up another controller in the container.
Can only be used when defining another controller.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">App.PostController = Ember.Controller.extend({
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>(optional) name of the controller to inject, defaults
to the property's name</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/Ember.InjectedProperty.html" class="crosslink">Ember.InjectedProperty</a></span>:
                    <p>injection descriptor instance</p>
...
<div id="method_service" class="method item public">
    <h3 class="name"><code>service</code></h3>
    ...
    <div class="meta">
                ...
                <p>
                Defined in
        <a href="../files/packages_ember-runtime_lib_system_service.js.html#l5"><code>packages&#x2F;ember-runtime&#x2F;lib&#x2F;system&#x2F;service.js:5</code></a>
        </p>
    ...
    <div class="description">
        <p>Creates a property that lazily looks up a service in the container. There
are no restrictions as to what objects a service can be injected into.</p>
<p>Example:</p>
<pre class="code prettyprint"><code class="language-javascript">App.ApplicationRoute = Ember.Route.extend({
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>(optional) name of the service to inject, defaults to
the property's name</p>

...
<head>
    <meta charset="utf-8">
    <title>Ember.FEATURES - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.FEATURES Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_features.js.html#l5"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;features.js:5</code></a>
        </div>
...
<div class="box intro">
    <p>The hash of enabled Canary features. Add to this, any canary features
before creating your application.</p>
<p>Alternatively (and recommended), you can also define <code>EmberENV.FEATURES</code>
if you need to enable features flagged at runtime.</p>
...
<div id="method_isEnabled" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_features.js.html#l20"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;features.js:20</code></a>
        </p>
    ...
    <div class="description">
        <p>Determine whether the specified <code>feature</code> is enabled. Used by Ember's
build tools to exclude experimental features from beta/stable builds.</p>
...
enabled/disabled.</li>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">feature</code>

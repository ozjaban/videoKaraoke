...
<head>
    <meta charset="utf-8">
    <title>Ember.Binding - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.Binding Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_binding.js.html#l353"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:353</code></a>
        </div>
    ...
    <div class="box deprecated">
        <p>
            <strong>Deprecated:</strong> See http://emberjs.com/deprecations/v2.x#toc_ember-binding
        </p>
    </div>

<div class="box intro">
    <p>An <code>Ember.Binding</code> connects the properties of two objects so that whenever
the value of one property changes, the other property will be changed also.</p>
<h2>Automatic Creation of Bindings with <code>/^*Binding/</code>-named Properties.</h2>
...
<pre class="code prettyprint"><code>valueBinding: &quot;MyApp.someController.title&quot;
</code></pre>
...
could do:</p>
<pre class="code prettyprint"><code>bigTitlesBinding: Ember.Binding.oneWay(&quot;MyApp.preferencesController.bigTitles&quot;)
</code></pre>
...
<h2>Adding Bindings Manually</h2>
...
<pre class="code prettyprint"><code class="language-javascript">binding = Ember.Binding.from(&quot;valueBinding&quot;).to(&quot;value&quot;);
</code></pre>
...
<pre class="code prettyprint"><code class="language-javascript">binding.connect(this);
</code></pre>
...
<pre class="code prettyprint"><code class="language-javascript">// Example 1
...
<pre class="code prettyprint"><code class="language-javascript">Ember.bind(MyApp.anotherObject, &quot;value&quot;, &quot;MyApp.someController.value&quot;);
</code></pre>
<p>Both of these code fragments have the same effect as doing the most friendly
form of binding creation like so:</p>
<pre class="code prettyprint"><code class="language-javascript">MyApp.anotherObject = Ember.Object.create({
...
<div id="method_connect" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l135"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:135</code></a>
        </p>
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>The root object for this binding.</p>
...
<div id="method_copy" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l51"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:51</code></a>
        </p>
...
<div id="method_disconnect" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l196"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:196</code></a>
        </p>
...
<div id="method_from" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l68"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:68</code></a>
        </p>
    ...
    <div class="description">
        <p>This will set <code>from</code> property path to the specified value. It will not
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>The property path to connect to.</p>
...
<div id="method_oneWay" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l106"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:106</code></a>
        </p>
    ...
    <div class="description">
        <p>Configures the binding as one way. A one-way binding will relay changes
...
<div id="method_to" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l87"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:87</code></a>
        </p>
    ...
    <div class="description">
        <p>This will set the <code>to</code> property path to the specified value. It will not
attempt to resolve this property path to an actual object until you
connect the binding.</p>
<p>The binding will search for the property path starting at the root object
you pass when you <code>connect()</code> the binding. It follows the same rules as
<code>get()</code> - see that method for more information.</p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">path</code>
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a> | Tuple</span>


                    <div class="param-description">
                        <p>A property path or tuple.</p>
...
<div id="method_toString" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_binding.js.html#l121"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;binding.js:121</code></a>
        </p>
    ...
    <div class="description">
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>:
                    <p>string representation of binding</p>

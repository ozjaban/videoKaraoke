...
<head>
    <meta charset="utf-8">
    <title>Ember.MapWithDefault - The Ember API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>Ember.MapWithDefault Class</h1>
<div class="box meta">

        <div class="extends">
            Extends <a href="../classes/Ember.Map.html" class="crosslink">Ember.Map</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/packages_ember-metal_lib_map.js.html#l411"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:411</code></a>
        </div>
...
<div class="box intro">
    ...
    <div class="constructor">
        <h2>Constructor</h2>
<div id="method_Ember.MapWithDefault" class="method item private">
    <h3 class="name"><code>Ember.MapWithDefault</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_map.js.html#l411"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:411</code></a>
        </p>
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        ...
                        <ul class="params-list">
                            <li class="param">
                                    <code class="param-name optional">[defaultValue]</code>
...
<div id="method_clear" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#method_clear">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l391"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:391</code></a>
        </p>
...
<div id="method_copy" class="method item private">
    <h3 class="name"><code>copy</code></h3>

        <span class="paren">()</span>

        <span class="returns-inline">
            <span class="type"><a href="../classes/Ember.MapWithDefault.html" class="crosslink">Ember.MapWithDefault</a></span>
        </span>
    ...
    <div class="meta">
            <p>Inherited from
            <a href="../classes/Ember.Map.html#method_copy">
                Ember.Map
            </a>
            but overwritten in
        <a href="../files/packages_ember-metal_lib_map.js.html#l467"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:467</code></a>
        </p>
...
<div id="method_create" class="method item private">
    <h3 class="name"><code>create</code></h3>
        ...
        <span class="returns-inline">
            <span class="type"><a href="../classes/Ember.MapWithDefault.html" class="crosslink">Ember.MapWithDefault</a> | <a href="../classes/Ember.Map.html" class="crosslink">Ember.Map</a></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/packages_ember-metal_lib_map.js.html#l425"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:425</code></a>
        </p>
    ...
    <div class="description">
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/Ember.MapWithDefault.html" class="crosslink">Ember.MapWithDefault</a> | <a href="../classes/Ember.Map.html" class="crosslink">Ember.Map</a></span>:
                    <p>If options are passed, returns
<code>Ember.MapWithDefault</code> otherwise returns <code>Ember.Map</code></p>
...
<div id="method_delete" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#method_delete">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l320"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:320</code></a>
        </p>
    ...
    <div class="description">
        <p>Removes a value from the map for an associated key.</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Boolean</span>:
                    <p>true if an item was removed, false otherwise</p>
...
<div id="method_forEach" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#method_forEach">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l358"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:358</code></a>
        </p>
    ...
    <div class="description">
        <p>Iterate over all the keys and values. Calls the function once
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>if passed, the <code>this</code> value inside the
callback. By default, <code>this</code> is the map.</p>
...
<div id="method_get" class="method item private">
    ...
    <div class="meta">
            <p>Inherited from
            <a href="../classes/Ember.Map.html#method_get">
                Ember.Map
            </a>
            but overwritten in
        <a href="../files/packages_ember-metal_lib_map.js.html#l447"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:447</code></a>
        </p>
    ...
    <div class="description">
        <p>Retrieve the value associated with a given key.</p>
...
<div id="method_has" class="method item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#method_has">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l346"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:346</code></a>
        </p>
    ...
    <div class="description">
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Boolean</span>:
                    <p>true if the item was present, false otherwise</p>
...
<div id="method_set" class="method item private inherited">
    <h3 class="name"><code>set</code></h3>
        ...
        <span class="returns-inline">
            <span class="type"><a href="../classes/Ember.Map.html" class="crosslink">Ember.Map</a></span>
        </span>
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#method_set">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l293"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:293</code></a>
        </p>
    ...
    <div class="description">
        <p>Adds a value to the map. If a value for the given key has already been
...
<div id="property_size" class="property item private inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Ember.Map.html#property_size">Ember.Map</a>:
        <a href="../files/packages_ember-metal_lib_map.js.html#l265"><code>packages&#x2F;ember-metal&#x2F;lib&#x2F;map.js:265</code></a>
        </p>
    ...
    <div class="description">
        <p>This property will change as the number of objects in the map changes.</p>
